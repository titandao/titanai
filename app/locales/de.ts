...
const de: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 TitanGPT AI Einführungsangebot, schalte jetzt OpenAI o1, GPT-4o, Claude-3.5 und die neuesten großen Modelle frei",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "TitanGPT AI verwenden",
        Label: "(Die kosteneffektivste Lösung)",
        SubTitle:
          "Offiziell von TitanGPT verwaltet, sofort einsatzbereit ohne Konfiguration, unterstützt die neuesten großen Modelle wie OpenAI o1, GPT-4o und Claude-3.5",
